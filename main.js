...
function update() {
    ...
    // if the ball touches top or bottom 
    ...
    // draw dotten line down the middle 
    for (let i = 10 ; i < board.height ; i += 25 ) {
        // i  = starting y position , draw a square every 25 pixels down 
        // x postion half of boardWidth - 10, i = y position , width = 5 , height = 5 
...
function detectCollision (a, b) {
    return a.x < b.x  + b.width && // a's top left corner doesnt' reach b's top right corner 
           ...
           a.y + a.height > b.y ;  // a's bottom left corner passses b's top left corner 
}
